...
namespace GrafikaSzeminarium
{
    internal class Program
    {
        ...
        private static uint gouraudProgram;  
        ...
        private static void CreateShaderPrograms()
        {
            ...
            string gouraudVertexShaderSource = @"
#version 330 core
...
void main()
{
    ...
    gl_Position = uProjection * uView * uModel * vec4(vPos.x, vPos.y, vPos.z, 1.0);
            ...
            string gouraudFragmentShaderSource = @"
#version 330 core
out vec4 FragColor;
...
void main()
{
    ...
    FragColor = vertexColor;
            ...
            Gl.ShaderSource(gouraudVShader, gouraudVertexShaderSource);
            ...
            Gl.ShaderSource(gouraudFShader, gouraudFragmentShaderSource);
