...
namespace GrafikaSzeminarium
{
    internal class Program
    {
        ...
        private static Vector3[] colorValues = new Vector3[]
        {
        ...
        private static Vector3 sideColor = new Vector3(1f, 0f, 0f);


        private static float shininess = 51.2f;
        ...
        private static unsafe void GraphicWindow_Render(double deltaTime)
        {
            ...
            //we need to add the new uniforms
            ...
            ImGuiNET.ImGui.SliderFloat3("Ambient Strength", ref ambientStrength, 0f, 1f);
            ImGuiNET.ImGui.SliderFloat3("Diffuse Strength", ref diffuseStrength, 0f, 1f);
            ImGuiNET.ImGui.SliderFloat3("Specular Strength", ref specularStrength, 0f, 1f);
            ImGuiNET.ImGui.SliderFloat3("Background Color", ref backgroundColor, 0f, 1f);
            string[] colors = { "Red", "Green", "Blue", "Yellow", "Magenta", "Cyan" };
            if (ImGuiNET.ImGui.Combo("Cube Side Color", ref selectedColorIndex, colors, colors.Length))
            {
                sideColor = colorValues[selectedColorIndex];
            }
            ImGuiNET.ImGui.End();
